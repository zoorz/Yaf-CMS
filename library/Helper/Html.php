...
class Html
{
    ...
    public static function getEncoding()
    {
        ...
        /*
        self::$encoding = Yaf_Application::app()->getConfig()
            ->get('application')
            ->get('encoding');
        */
     ...
     * 
     * @param Yaf_View_Interface $view The view instance
     * @param string|array        $args An array of javascript paths or a 
     *                                  string with javascript path to load.
     */
    public static function appendJavascript( $view, $args)
    {
     ...
     */
    public static function appendCss( $view, $args)
    {
        if ( !isset($view->css)) {
            $view->assign('css', '');
        }
